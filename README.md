...
```
For advanced users who want to explore Rdata objects generated by SMAGEXP thanks to Galaxy's Rstudio Interactive Environment, we need to be able to launch Docker containers inside our Galaxy Docker container. At least docker 1.3 is needed on the host system.
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNDc2MzIwMjgsLTE5NzE5MTU1LC00ND
