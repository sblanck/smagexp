...
Given several Rdata fobject the microarray meta-analysis tool run a meta-analysis using the metaMA R package.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgyNTM1NzMxNiwtNDQ2MzUwNDU4LC0xOD
