...
SMAGEXP handles affymetrix .CEL files. .CEL files have to be normalized d'abor QCnormalization. Cet outil permet de normaliser les données issues des fichiers .CEL et de s'assurer de la qualité de ces données.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ0ODUxMjAzNywtMTg5OTI4MjIxNCwtMT
EyNDcwMjYyNl19
-->