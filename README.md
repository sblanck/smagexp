...
```
For advanced users who wants to explore Rdata objects generated by smagexp thanks to Galaxy's Rstudio Interactive Enviromnent
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY0MjI4OTU4NSwzNDcxNDAzNjcsMzQyOT
