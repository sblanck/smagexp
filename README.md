...
Given several Rdata from the lobject the microarray meta-analysis tool run a meta-analysis using the metaMA R package.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYxNDgyODMwMSwtODI1MzU3MzE2LC0xOD
