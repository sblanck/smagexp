...
- Table summarizing the differentially expressed genes and their annotations. This table is sortable, requestable and annotated. When a row is expended, link to NCBI gene annotations and Gene Ontology functions are available
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODk1ODExMDYsNDYxMDYxMzExLDE5NT
