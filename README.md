...
Given several Rdata from the limma object the microarray meta-analysis tool run a meta-analysis using the metaMA R package.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwODIxMDc5NDUsLTgyNTM1NzMxNiwtMT
