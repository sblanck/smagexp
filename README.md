...
```
For advanced users who wants to explore Rdata objects generated by smagexp thanks to Galaxy's Rstudio Interactive Enviromnent, we need to be able to launch Docker containers inside our Galaxy Docker container. At least docker 1.3 is needed on the host system.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAxMDE4NjI5NiwzNDcxNDAzNjcsMzQyOT
